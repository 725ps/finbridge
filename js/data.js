...
entityStatuses: [
  { id:"TOY-UAE", pct:56, status:"at_risk", tasksDone:9, tasksTotal:16, blocked:1,
    blocker:{ task:"IC Balance Matching", desc:"AED 340K mismatch between Toyota UAE and Central Procurement. 3 vehicles received by Toyota UAE but goods receipt not posted in S/4HANA (DMS recorded receipt, SAP sync missed them).", resolution:"Post 3 missing goods receipts in S/4HANA MM.", resolutionAssignee:"Fatima Al-Hashemi (Inventory Controller)", estEffort:"30 minutes", taskId:"T-IC-MATCH", subProcess:"SP-IC", blocks:["IC Difference Resolution","Entity Review","Consolidation"] },
    subProcessStatuses: [
      {id:"SP-DMS",status:"completed",pct:100},{id:"SP-AP",status:"completed",pct:100},{id:"SP-AR",status:"completed",pct:100},{id:"SP-PAY",status:"completed",pct:100},
      {id:"SP-ASSET",status:"completed",pct:100},{id:"SP-INV",status:"completed",pct:100},{id:"SP-EXP",status:"completed",pct:100},
      {id:"SP-BANK",status:"in_progress",pct:75},{id:"SP-IC",status:"blocked",pct:40},{id:"SP-TAX",status:"in_progress",pct:60},
      {id:"SP-FX",status:"waiting",pct:0},{id:"SP-PROV",status:"waiting",pct:0},{id:"SP-REVIEW",status:"waiting",pct:0},{id:"SP-CONSOL",status:"waiting",pct:0},{id:"SP-REPORT",status:"waiting",pct:0},
    ],
  },
  { id:"LEX-UAE", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"HON-UAE", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"VOL-UAE", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"BYD-UAE", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"STE-UAE", pct:52, status:"on_track", tasksDone:8, tasksTotal:16, blocked:0,
    subProcessStatuses: [
      {id:"SP-DMS",status:"completed",pct:100},{id:"SP-AP",status:"completed",pct:100},{id:"SP-AR",status:"completed",pct:100},{id:"SP-PAY",status:"completed",pct:100},
      {id:"SP-ASSET",status:"completed",pct:100},{id:"SP-INV",status:"in_progress",pct:50},{id:"SP-EXP",status:"completed",pct:100},
      {id:"SP-BANK",status:"in_progress",pct:50},{id:"SP-IC",status:"not_started",pct:0},{id:"SP-TAX",status:"not_started",pct:0},
      {id:"SP-FX",status:"waiting",pct:0},{id:"SP-PROV",status:"waiting",pct:0},{id:"SP-REVIEW",status:"waiting",pct:0},{id:"SP-CONSOL",status:"waiting",pct:0},{id:"SP-REPORT",status:"waiting",pct:0},
    ],
  },
  { id:"TOY-KSA", pct:34, status:"at_risk", tasksDone:5, tasksTotal:16, blocked:1,
    blocker:{ task:"DMS Sync Verification", desc:"DMS sync failed. API timeout on Jeddah batch (34 transactions). Data validation failure on Riyadh batch (13 service ROs created without cost center assignment).", resolution:"IT to restart Jeddah sync (manual trigger). Finance to bulk-assign cost center to 13 Riyadh ROs.", resolutionAssignee:"IT Operations + Riyadh Finance", estEffort:"2 hours", taskId:"T-DMS-VERIFY", subProcess:"SP-DMS", blocks:["AR Close","Inventory Recon","Tax Calculation","Entity Review","Consolidation"] },
    subProcessStatuses: [
      {id:"SP-DMS",status:"blocked",pct:0},{id:"SP-AP",status:"completed",pct:100},{id:"SP-AR",status:"waiting",pct:0},{id:"SP-PAY",status:"completed",pct:100},
      {id:"SP-ASSET",status:"completed",pct:100},{id:"SP-INV",status:"waiting",pct:0},{id:"SP-EXP",status:"completed",pct:100},
      {id:"SP-BANK",status:"in_progress",pct:50},{id:"SP-IC",status:"waiting",pct:0},{id:"SP-TAX",status:"waiting",pct:0},
      {id:"SP-FX",status:"waiting",pct:0},{id:"SP-PROV",status:"waiting",pct:0},{id:"SP-REVIEW",status:"waiting",pct:0},{id:"SP-CONSOL",status:"waiting",pct:0},{id:"SP-REPORT",status:"waiting",pct:0},
    ],
  },
  { id:"LEX-KSA", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"HON-KSA", pct:58, status:"on_track", tasksDone:9, tasksTotal:16, blocked:0 },
  { id:"TOY-KWT", pct:48, status:"on_track", tasksDone:7, tasksTotal:16, blocked:0 },
  { id:"LEX-KWT", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"HON-KWT", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"TOY-QAT", pct:100, status:"closed", tasksDone:16, tasksTotal:16, blocked:0 },
  { id:"LEX-QAT", pct:62, status:"on_track", tasksDone:10, tasksTotal:16, blocked:0 },
  { id:"TOY-BHR", pct:45, status:"on_track", tasksDone:7, tasksTotal:16, blocked:0 },
  { id:"TOY-OMN", pct:62, status:"on_track", tasksDone:10, tasksTotal:16, blocked:0 },
  { id:"STE-KSA", pct:38, status:"on_track", tasksDone:6, tasksTotal:16, blocked:0 },
  { id:"VOL-KSA", pct:44, status:"on_track", tasksDone:7, tasksTotal:16, blocked:0 },
  { id:"TOY-EGY", pct:30, status:"at_risk", tasksDone:4, tasksTotal:16, blocked:1,
    blocker:{ task:"Currency Revaluation", desc:"EGP depreciated 6.8% in June (0.073 to 0.068 AED). Toyota Egypt has AED 20.6M in EGP-denominated receivables. Unrealized FX loss: AED 1.4M. Approaching treasury FX risk policy threshold.", resolution:"Treasury to evaluate hedging position on EGP exposure. Flag for CFO monthly risk report.", resolutionAssignee:"Treasury Manager", estEffort:"4 hours", taskId:"T-FX-REVAL", subProcess:"SP-FX", blocks:["Entity Review","Consolidation"] },
  },
  { id:"TOY-PAK", pct:22, status:"at_risk", tasksDone:3, tasksTotal:16, blocked:1,
    blocker:{ task:"Payroll Posting", desc:"Pakistan payroll posting delayed. HR has not approved the overtime calculation for June. 142 employees affected. Payroll journal cannot be posted to S/4HANA until HR sign-off.", resolution:"Escalate to HR Director Pakistan. If not resolved by Day 4, post estimated accrual and adjust in July.", resolutionAssignee:"HR Finance Manager + HR Director Pakistan", estEffort:"1 hour (escalation) or 30 min (accrual)", taskId:"T-PAY-POST", subProcess:"SP-PAY", blocks:["Trial Balance Review","Entity Review","Consolidation"] },
  },
],
